...
percentage_list = [0.0664, 0.346, 0.196, 0.0072, 0.0368, 0.0208, 0.0356, 0.186, 0.1052] # percentages of the HETUS 2021 
#  [0.0573,0.2797,0.1583,0.00059,0.0308,0.0174,0.0496,0.2584,0.1462] -> original composition
total_users = 161
...
if __name__ == "__main__":
    ...
    uc = UseCase(
        ...
        date_start='2021-12-30', #real date starts from 16
        date_end = '2023-01-02', #real date ends on 22
        peak_enlarge=0.0,
    ...
    #export the data
    pp.export_series(Profiles_series,4,'Mobility_scenario_plan_day_ahead')
    dummy_days_corrected = pp.Charging_series_dummy_days(Charging_series)#, uc.days)
    pp.export_series(dummy_days_corrected,1,'Charging_scenario_plan_day_ahead')
