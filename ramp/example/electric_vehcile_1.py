...
countries = ['NL']
#print('run vehcile')
percentage_list = [0.0573,0.2797,0.1583,0.00059,0.0308,0.0174,0.0496,0.2584,0.1462]
#[0.0573,0.2797,0.1583,0.00059,0.0308,0.0174,0.0496,0.2584,0.1462] # percentages of the HETUS 2021
#[0.0664, 0.346, 0.196, 0.072, 0.0368, 0.0208, 0.0356, 0.186, 0.1052] # original composition
#  [0.0573,0.2797,0.1583,0.00059,0.0308,0.0174,0.0496,0.2584,0.1462] # Percentage of Hetus
total_users = 100
...
if __name__ == "__main__":
    ...
    #export the data
    pp.export_series(Profiles_series,4,'Mobility_Plan_day_ahead_SA1.83')
    dummy_days_corrected = pp.Charging_series_dummy_days(Charging_series, uc.days)
    pp.export_series(dummy_days_corrected,1,'Charging_Plan_day_ahead_val_1')
    charging_profiles_per_location = [uc.locational_charging(i) for i in range(1,5)]
    ...
    #print(charging_coincidence, mobility_usage)
