...
r_w['free time'] = 0.2 #0.2

#Occasional use 
occasional_use = {}

occasional_use['weekday'] = 1
occasional_use['saturday'] = 1#0.6
occasional_use['sunday'] = 1#0.5
occasional_use['free time'] = {'weekday': 0.25, 'saturday': 0.40,'sunday':0.40} #1/7, meaning taking car for free time once a week. weekday 0.15, weekend 0.3
...
#Trips distribution by hours of the day
trips = {}
...
#print(f'perc_usage after free time complementary {perc_usage}')
#%% Return the data in Object Format to automatically define the objects.
""" Return the data for users and EV objects"""

def load_country_ev_data():
    country_data= {
        "pop_sh": {"working": pop_sh['working'], "student": pop_sh['student'], "inactive": pop_sh['inactive']},
        "vehicle_sh": {"large": vehicle_sh['large'], "medium":vehicle_sh['medium'], "small": vehicle_sh['small']},
        
        "working": {
            "large":{"distance_random_variability":r_d,
                     "velocity_random_variability":r_v,
                     "power_random_variability":P_var,#list of parameters
                     "power_parameters": Par_P_EV['large'],
                     "battery_capacity": Battery_cap['large'],
                     "location_preference_factor":1
                     },
         
            "medium":{"distance_random_variability":r_d,
                     "velocity_random_variability":r_v,
                     "power_random_variability":P_var,
                     "power_parameters": Par_P_EV['medium'],
                     "battery_capacity": Battery_cap['medium'],
                     "location_preference_factor":1#list of parameters
                     },
         
            "small":{"distance_random_variability":r_d,
                     "velocity_random_variability":r_v,
                     "power_random_variability":P_var,
                     "power_parameters": Par_P_EV['small'],
                     "battery_capacity": Battery_cap['small'],
                     "location_preference_factor":1#list of parameters
                     }}
